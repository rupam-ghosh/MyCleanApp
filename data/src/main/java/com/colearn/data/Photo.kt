...
import com.colearn.data.CurrentUserCollection
import com.colearn.data.Links
...
class Photo : Parcelable {
    ...
    protected constructor(`in`: Parcel) {
        ...
        currentUserCollections?.let { `in`.readList(it, CurrentUserCollection::class.java.classLoader) }
